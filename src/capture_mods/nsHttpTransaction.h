...
#ifdef CAVISSON
    nsCString              GetRequest()     { return mReqHeaderBuf; }
    nsIInputStream        *GetUploadStream() { return mReqUploadStream; }
     nsCString              GetLineBuf()     { return mLineBuf; }
#endif /* CAVISSON */
