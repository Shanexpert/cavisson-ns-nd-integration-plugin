/* 
 * Name: tr069_cpe_execute_set_parameter_values
 * Purpose: Execute set parameter values RPC and get next rpc to execute
 *
 *
 */
...
void tr069_execute_set_parameter_values()
{
double wait_time = .1; // .1 Seconds  (100 milli seconds)

    ns_start_transaction("TR069SetParameterValues");
    int rpc_name = ns_tr069_cpe_execute_set_parameter_values();
