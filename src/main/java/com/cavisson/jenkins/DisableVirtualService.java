...
public class DisableVirtualService extends Builder implements SimpleBuildStep {

	private final String serviceName;
	private String API = "/ProductUI/cavservices/virtualize/v4/disableservice?token="+ CreateVirtualService.TOKEN;
	private String URLPath = CreateVirtualService.HOST + API;

	@DataBoundConstructor
	public DisableVirtualService(String serviceName) {
	...
	public static class Descriptor extends BuildStepDescriptor<Builder> {
		...
		public String getDisplayName() {
			return Messages.DisableVirtualService_Task();
		}
	}
