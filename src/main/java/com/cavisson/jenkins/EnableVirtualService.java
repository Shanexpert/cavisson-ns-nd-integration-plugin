...
public class EnableVirtualService extends Builder implements SimpleBuildStep {

	private final String serviceName;
	private String API = "/ProductUI/cavservices/virtualize/v4/enableservice?token="+ CreateVirtualService.TOKEN;
	private String URLPath = CreateVirtualService.HOST + API;

	@DataBoundConstructor
	public EnableVirtualService(String serviceName) {
	...
	public static class Descriptor extends BuildStepDescriptor<Builder> {
		...
		public String getDisplayName() {
			return Messages.EnableVirtualService_Task();
		}
	}
